...
const Navheader: React.FC<NavHeaderProps> = ({ variant = 'default' }) => {
  ...
  //   {
  //     "bg-white/50 border-white/30": variant === 'default',
  //     "bg-transparent border-none": variant === 'transparent',
  //     "bg-gradient-to-br from-sky-800 via-sky-200 to-sky-100/80 border-white/30": variant === 'hero',
  //   }
  // );

  const headerClasses = clsx(
  "fixed top-0 left-0 right-0 z-50 mx-auto max-w-6xl",
  "rounded-3xl shadow-sm backdrop-blur-md m-4 px-6 py-4", // common modern styles
  {
  ...
  <div className="flex items-center justify-between ">
    ...
    <div className="md:hidden">
      <Sheet>
        ...
        <SheetContent side="right" className="w-64 bg-white text-gray-800">
