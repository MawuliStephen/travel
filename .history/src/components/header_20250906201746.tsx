...
const Navheader: React.FC<NavHeaderProps> = ({ variant = 'default' }) => {
  ...
  "fixed top-0 left-0 right-0 z-50 mx-auto max-w-[96%]",
  "rounded-full shadow-sm backdrop-blur-md m-4 px-6 py-2", // common modern styles
  {
    ...
    <div className="hidden md:block">
      <Button
        ...
        // className="border-sky-600 text-sky-700 hover:bg-sky-100"
          // className="border-dark-600 rounded-2xl text-dark-700 hover:bg-dark-100"
